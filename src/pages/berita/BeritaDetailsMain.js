        ...
        <div className="row">
          <div className="col-lg-8">
            <div className="berita-single-inner">
              <div className="berita-content">
                ...
                <div className="berita-order-list pb---25">
                ...
                <div className="berita-tags">
                  <div className="row align-items-center">
                    ...
                    <div className="col-md-6">
                      <div className="share-berita">Share this post:
                ...
                <div className="single-nav">
                  <div className="berita-prev"> <Link to="#"><i className="berita-icon arrow_carrot-left"></i> PREV POST <em>Graduate Admissions</em></Link> </div>
                  <div className="berita-next"><Link to="#"> NEXT POST <i className="berita-icon arrow_carrot-right"></i> <em> Less is More</em></Link></div>
                </div>

                <div className="react-berita-filter related__berita">
                  <h3>Related Posts</h3>
                  <div className="row">
                    {posts.map((data, index) => {
                      return (
                        <div key={index} className="single-studies col-md-4 grid-item">
                          <div className="inner-berita">
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-11">
                          <div className="dsc-comments">
                            ...
                            <Link to="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-corner-up-left"><polyline points="9 14 4 9 9 4"></polyline><path d="M20 20v-7a4 4 0 0 0-4-4H4"></path></svg> Reply</Link>
                          </div>
                        </div>
                      </div>
                    </li>
                ...
                <div className="berita-blog-form">
                    ...
                    <form>
                      <div className="row">
                        <div className="col-lg-12">
                          <div className="berita-textarea">
                            <textarea placeholder="Message"></textarea>
                          </div>
                        </div>
                        <div className="col-lg-6">
                          <div className="berita-input">
          ...
          <div className="col-lg-4 md-mt-60">
            <div className="react-sidebar ml----30">
              <div className="widget berita-search">
              ...
              <div className="widget berita-post">
                <h3 className="widget-title">Popular Posts</h3>
                <ul className="related-berita">
                  {posts.map((data, index) => {
                    return (
                      <li key={index}>
              ...
              <div className="widget react-categories-berita">
                <h3 className="widget-title">News Categories</h3>
                <ul className="recent-category">
                  <li> <Link to="#">Politics <em>(6)</em></Link></li>
                  <li> <Link to="#">Sports <em>(4)</em></Link></li>
                  <li> <Link to="#">Technology <em>(8)</em></Link></li>
                  <li> <Link to="#">Health <em>(3)</em></Link></li>
                  <li> <Link to="#">Entertainment <em>(5)</em></Link></li>
                  <li> <Link to="#">Business <em>(2)</em></Link></li>
                  <li> <Link to="#">World <em>(10)</em></Link></li>
                  <li> <Link to="#">Science <em>(2)</em></Link></li>
                  <li> <Link to="#">Travel <em>(7)</em></Link></li>
                </ul>
              </div>
              <div className="widget widget-tags">
                ...
                <ul className="tags">
                  ...
                  <li><Link to="#">Latest Updates</Link></li>
